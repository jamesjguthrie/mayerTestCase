...
Foam::jaboTransport<Thermo, PolySize>::jaboTransport(Istream& is)
:
    Thermo(is),
...
template<class Thermo, int PolySize>
Foam::jaboTransport<Thermo, PolySize>::jaboTransport
(
...
template<class Thermo, int PolySize>
void Foam::jaboTransport<Thermo, PolySize>::write(Ostream& os) const
{
    os  << this->name() << endl;
...
)
{
    ...
    (
        ...
        "("
            "Ostream&, "
            "const jaboTransport<Thermo, PolySize>&"
        ")"
    );
