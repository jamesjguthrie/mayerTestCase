...
class RADAU5s: private RADAU5
{

public:
	//Constructors

    	virtual void RADAU5jacobian(double x, double *y, double **J) const = 0;
    	virtual void RADAU5mass(double **M) const = 0;

	RADAU5s(const int nin, double yin[], double xin, double xendin,
	...
	RADAU5s(int nin, double yin[], double xin, double xendin, double dxin,
		const int ijacin, int mljacin, int mujacin, const int imasin,
		int mlmasin, int mumasin);
		

	void ResetT(double yin[], double xin, double xendin,
	double dxin, int itolerin, double *rtolerin, double *atolerin, 
