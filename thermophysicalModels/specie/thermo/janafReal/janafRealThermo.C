...
void Foam::janafRealThermo<EquationOfState>::checkInputData() const
{
    if (Tlow_ >= Thigh_)
    {
        FatalErrorIn("janafRealThermo<EquationOfState>::check()")
...
template<class EquationOfState>
Foam::janafRealThermo<EquationOfState>::janafRealThermo(Istream& is)
:
    EquationOfState(is),
    Tlow_(readScalar(is)),
    ...
    Tcommon_(readScalar(is))
{
    ...
    is.check("janafRealThermo::janafRealThermo(Istream& is)");
}


template<class EquationOfState>
Foam::janafRealThermo<EquationOfState>::janafRealThermo(const dictionary& dict)
:
...
template<class EquationOfState>
void Foam::janafRealThermo<EquationOfState>::write(Ostream& os) const
{
...
)
{
    ...
    os.check
    (
        "operator<<(Ostream& os, const janafRealThermo<EquationOfState>& jt)"
    );
